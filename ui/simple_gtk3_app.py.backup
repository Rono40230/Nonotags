...
class AlbumCard(Gtk.Frame):
    ...
    def __init__(self, album_data: Dict):
        ...
        if response == Gtk.ResponseType.OK:
            ...
            # Lance le scan dans un thread séparé pour éviter le blocage de l'UI
    ...
    def _start_scanning(self, folder_path: str):
        ...
        try:
            ...
            # Met à jour l'interface avec les albums trouvés
